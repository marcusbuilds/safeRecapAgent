...
`safeRecapAgent` is a FastAPI prototype for meeting summarization with local term redaction and post-processing rules before results are returned.
...
`safeRecapAgent` is a privacy-first meeting summarization app 
---
